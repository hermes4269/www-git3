...
//	$val_niz_plus="tr-11-prazan.js";
	$val_niz_plus="Popovica_Slaninarski_Krug.gpx";

	if(!($myFile=@fopen($val_niz_plus,"r"))){
    printf("problem sa stranicom ulaz:%s <br>",$val_niz_plus);      
    exit; 
	}
	else{	  
		$myLine="";
